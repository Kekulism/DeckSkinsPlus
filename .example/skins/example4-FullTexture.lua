...
local skin = {
	...
	---    Use 'deck' if your texture matches a deck layout (full ranks for each suit top to bottom, you will likely need to use this if your texture contains multiple suits).
	posStyle = 'deck',
